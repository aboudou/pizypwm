...
class PiZyPwm(threading.Thread):
  ...
  def __init__(self, frequency, gpioPin, mcp):
     """ 
  ...
  def start(self, dutyCycle):
    ...
    self.mcp.config(self.gpioPin, self.mcp.OUTPUT)
  ...
  def stop(self):
    ...
    self.mcp.output(self.gpioPin, 0) 
    self.mcp.config(self.gpioPin, self.mcp.INPUT)
